...
<html lang="en">
<head>
	<title>Magnifique | Lingerie & Lounge</title>
	<meta charset="utf-8" />
	...
	<div class="content-container">
		<div class="categories-side">
			<div id="categoriesWrapper" >
				<h2>LINGERIE & LOUNGE</h2>
				<h4>CATEGORY</h4>
				<ul class="category-links">
					<li><a href="#ll-bras">Bras</a></li>
					<li><a href="#ll-panties">Panties</a></li>
					<li><a href="#ll-lingerie-sets">Lingerie Sets</a></li>
					<li><a href="#ll-sexy-lingerie">Sexy Lingerie</a></li>
					<li><a href="#ll-sleep-loungewear">Sleep & Loungewear</a></li>
				</ul>	
			</div>
		</div>
		<div class="items-side">
			...
			<div class="items-container">
				...
				<div class="items-group">
					<h4 id="ll-bras" style="padding-top: 25px;">Bras</h4>
				<?php
					$prodType = "Bras";
					$getProdByType =getProductByType($conn, $prodType);

					while ($row = mysqli_fetch_assoc($getProdByType)) { ?>
					<a href="lingerie-lounge-product.php?product_id=<?php echo $row["product_id"]; ?>">
						<div class="item">
							<img src="img/magnifique-items/lingerie-lounge/<?php echo $row["product_image_1"]; ?>">
				...
				<div class="items-group">
					<h4 id="ll-panties" style="padding-top: 25px;">Panties</h4>
				<?php
					$prodType = "Panties";
					$getProdByType =getProductByType($conn, $prodType);
				...
				<div class="items-group">
					<h4 id="ll-lingerie-sets" style="padding-top: 25px;">Lingerie Sets</h4>
				<?php
					$prodType = "Lingerie Sets";
					$getProdByType =getProductByType($conn, $prodType);
				...
				<div class="items-group">
					<h4 id="ll-sexy-lingerie" style="padding-top: 25px;">Sexy Lingerie</h4>
				<?php
					$prodType = "Sexy Lingerie";
					$getProdByType =getProductByType($conn, $prodType);
				...
				<div class="items-group">
					<h4 id="ll-sleep-loungewear" style="padding-top: 25px;">Sleep & Loungewear</h4>
				<?php
					$prodType = "Sleep & Loungewear";
					$getProdByType =getProductByType($conn, $prodType);
