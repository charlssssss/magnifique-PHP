...
<html lang="en">
<head>
	<title>Magnifique | Women's Shoes</title>
	<meta charset="utf-8" />
		...
		<div class="categories-side">
			<div id="categoriesWrapper" >
				...
				<ul class="category-links">
					<li><a href="#ws-sneakers">Sneakers</a></li>
					<li><a href="#ws-sandals">Sandals</a></li>
					<li><a href="#ws-flat-shoes">Flat Shoes</a></li>
					<li><a href="#ws-slides-flipflops">Slides & Flip Flops</a></li>
					<li><a href="#ws-heels">Heels</a></li>
				</ul>	
			</div>
		</div>
		<div class="items-side">
			...
			<div class="items-container">
				...
				<div class="items-group">
					<h4 id="ws-sneakers" style="padding-top: 25px;">Sneakers</h4>
				<?php
					$prodType = "Sneakers";
					$getProdByType =getProductByType($conn, $prodType);

					while ($row = mysqli_fetch_assoc($getProdByType)) { ?>
					<a href="womens-shoes-product.php?product_id=<?php echo $row["product_id"]; ?>">
						<div class="item">
							<img src="img/magnifique-items/womens-shoes/<?php echo $row["product_image_1"]; ?>">
				...
				<div class="items-group">
					<h4 id="ws-sandals" style="padding-top: 25px;">Sandals</h4>
				<?php
					$prodType = "Sandals";
					$getProdByType =getProductByType($conn, $prodType);
				...
				<div class="items-group">
					<h4 id="ws-flat-shoes" style="padding-top: 25px;">Flat Shoes</h4>
				<?php
					$prodType = "Flat Shoes";
					$getProdByType =getProductByType($conn, $prodType);
				...
				<div class="items-group">
					<h4 id="ws-slides-flipflops" style="padding-top: 25px;">Slides & Flip Flops</h4>
				<?php
					$prodType = "Slides & Flip Flops";
					$getProdByType =getProductByType($conn, $prodType);
				...
				<div class="items-group">
					<h4 id="ws-heels" style="padding-top: 25px;">Heels</h4>
				<?php
					$prodType = "Heels";
					$getProdByType =getProductByType($conn, $prodType);
