...
<html lang="en">
<head>
	<title>Magnifique | Accessories</title>
	<meta charset="utf-8" />
		...
		<div class="categories-side">
			<div id="categoriesWrapper" >
				...
				<ul class="category-links">
					<li><a href="#ac-socks-tights">Socks & Tights</a></li>
					<li><a href="#ac-belts">Belts</a></li>
					<li><a href="#ac-scarves">Scarves</a></li>
					<li><a href="#ac-umbrellas">Umbrellas</a></li>
					<li><a href="#ac-hats-caps">Hats & Caps</a></li>
				</ul>	
			</div>
		</div>
		<div class="items-side">
			...
			<div class="items-container">
				...
				<div class="items-group">
					<h4 id="ac-socks-tights" style="padding-top: 25px;">Socks & Tights</h4>
				<?php
					$prodType = "Socks & Tights";
					$getProdByType =getProductByType($conn, $prodType);

					while ($row = mysqli_fetch_assoc($getProdByType)) { ?>
					<a href="accessories-product.php?product_id=<?php echo $row["product_id"]; ?>">
						<div class="item">
							<img src="img/magnifique-items/accessories/<?php echo $row["product_image_1"]; ?>">
				...
				<div class="items-group">
					<h4 id="ac-belts" style="padding-top: 25px;">Belts</h4>
				<?php
					$prodType = "Belts";
					$getProdByType =getProductByType($conn, $prodType);
				...
				<div class="items-group">
					<h4 id="ac-scarves" style="padding-top: 25px;">Scarves</h4>
				<?php
					$prodType = "Scarves";
					$getProdByType =getProductByType($conn, $prodType);
				...
				<div class="items-group">
					<h4 id="ac-umbrellas" style="padding-top: 25px;">Umbrellas</h4>
				<?php
					$prodType = "Umbrellas";
					$getProdByType =getProductByType($conn, $prodType);
				...
				<div class="items-group">
					<h4 id="ac-hats-caps" style="padding-top: 25px;">Hats & Caps</h4>
				<?php
					$prodType = "Hats & Caps";
					$getProdByType =getProductByType($conn, $prodType);
