...
<body>
	...
	<?php
		if(isset($_GET["product_id"])) {
			...
			$img1 = "\"img/magnifique-items/accessories/" . $getProduct["product_image_1"]. "\"";
			$img2 = "\"img/magnifique-items/accessories/" . $getProduct["product_image_2"]. "\"";
			$img3 = "\"img/magnifique-items/accessories/" . $getProduct["product_image_3"]. "\"";
			$img4 = "\"img/magnifique-items/accessories/" . $getProduct["product_image_4"]. "\"";
		...
		<div class="breadcrumb">
			<p>
				<a href="accessories.php">Accessories</a>
				 / 
				 <?php
				 	if (str_contains($product_id,"acst")) {
				 		echo "<a href='accessories.php#ac-socks-tights'>Socks & Tights</a>";
				 	}
				 	else if (str_contains($product_id,"acs")) {
				 		echo "<a href='accessories.php#ac-scarves'>Scarves</a>";
				 	}

				 	if (str_contains($product_id,"acb")) {
				 		echo "<a href='accessories.php#ac-belts'>Belts</a>";
				 	}
				 	
				 	if (str_contains($product_id,"acu")) {
				 		echo "<a href='accessories.php#ac-umbrellas'>Umbrellas</a>";
				 	}
				 	if (str_contains($product_id,"achc")) {
				 		echo "<a href='accessories.php#ac-hats-caps'>Hats & Caps</a>";
				 	}
				 ?>
				 / 
				<a href="accessories-product.php?product_id=<?php echo $product_id; ?>"><?php echo $getProduct["product_name"]; ?></a>
			</p>
		</div>
	...
	<div class="content-container">
		<div class="thumbnail-side">
			<div id="image1" class="thumb-box">
				<img onclick='img1(<?php echo $img1; ?>)' src="img/magnifique-items/accessories/<?php echo $getProduct["product_image_1"]; ?>" >
			</div>
			<div id="image2" class="thumb-box">
				<img onclick='img2(<?php echo $img2; ?>)' src="img/magnifique-items/accessories/<?php echo $getProduct["product_image_2"]; ?>" >
			</div>
			<div id="image3" class="thumb-box">
				<img onclick='img3(<?php echo $img3; ?>)' src="img/magnifique-items/accessories/<?php echo $getProduct["product_image_3"]; ?>" >
			</div>
			<div id="image4" class="thumb-box">
				<img onclick='img4(<?php echo $img4; ?>)' src="img/magnifique-items/accessories/<?php echo $getProduct["product_image_4"]; ?>" >
			</div>
		</div>
		<div class="image-side"> <!-- main image section -->
			<img id="main-img" src="img/magnifique-items/accessories/<?php echo $getProduct["product_image_1"]; ?>" >
		</div>
		<form method="POST" action="includes/addcart.inc.php?prod_id=<?php echo $getProduct["product_id"]; ?>" class="details-side"><!-- details section -->
			...
			<input type="hidden" name="prod_img_path" value="img/magnifique-items/accessories/">
			<input type="hidden" name="prod_link" value="accessories-product.php">
			...
			<?php
				...
				$order_detail = array(
					...
					'qty' => '1',
					'img_path' => "img/magnifique-items/accessories/". $getProduct["product_image_1"],
					'cart_id' =>  "none"
				);
			...
			<?php
				if(isset($_SESSION["customer_id"])) {
					...
					echo "<input type='hidden' name='prev_link' value='accessories-product.php?product_id=".$getProduct['product_id']."'>";
			...
			<form method="POST" action="includes/review-rate.inc.php" class="review-form">
				...
				<div class="rev-form-content">
					<div class="rev-image-side">
						<img src="img/magnifique-items/accessories/<?php echo $getProduct["product_image_1"]; ?>">
					</div>
