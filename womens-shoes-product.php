...
<body>
	...
	<?php
		if(isset($_GET["product_id"])) {
			...
			$img1 = "\"img/magnifique-items/womens-shoes/" . $getProduct["product_image_1"]. "\"";
			$img2 = "\"img/magnifique-items/womens-shoes/" . $getProduct["product_image_2"]. "\"";
			$img3 = "\"img/magnifique-items/womens-shoes/" . $getProduct["product_image_3"]. "\"";
			$img4 = "\"img/magnifique-items/womens-shoes/" . $getProduct["product_image_4"]. "\"";
		...
		<div class="breadcrumb">
			<p>
				<a href="womens-shoes.php">Women's Shoes</a>
				 / 
				 <?php
				 	if (str_contains($product_id,"wssn")) {
				 		echo "<a href='womens-shoes.php#ws-sneakers'>Sneakers</a>";
				 	}
				 	if (str_contains($product_id,"wssa")) {
				 		echo "<a href='womens-shoes.php#ws-sandals'>Sandals</a>";
				 	}
				 	if (str_contains($product_id,"wsfs")) {
				 		echo "<a href='womens-shoes.php#ws-flat-shoes'>Flat Shoes</a>";
				 	}
				 	if (str_contains($product_id,"wsff")) {
				 		echo "<a href='womens-shoes.php#ws-slides-flipflops'>Slides & Flip Flops</a>";
				 	}
				 	if (str_contains($product_id,"wsh")) {
				 		echo "<a href='womens-shoes.php#ws-heels'>Heels</a>";
				 	}
				 ?>
				 / 
				<a href="womens-shoes-product.php?product_id=<?php echo $product_id; ?>"><?php echo $getProduct["product_name"]; ?></a>
			</p>
		</div>
	...
	<div class="content-container">
		<div class="thumbnail-side">
			<div id="image1" class="thumb-box">
				<img onclick='img1(<?php echo $img1; ?>)' src="img/magnifique-items/womens-shoes/<?php echo $getProduct["product_image_1"]; ?>" >
			</div>
			<div id="image2" class="thumb-box">
				<img onclick='img2(<?php echo $img2; ?>)' src="img/magnifique-items/womens-shoes/<?php echo $getProduct["product_image_2"]; ?>" >
			</div>
			<div id="image3" class="thumb-box">
				<img onclick='img3(<?php echo $img3; ?>)' src="img/magnifique-items/womens-shoes/<?php echo $getProduct["product_image_3"]; ?>" >
			</div>
			<div id="image4" class="thumb-box">
				<img onclick='img4(<?php echo $img4; ?>)' src="img/magnifique-items/womens-shoes/<?php echo $getProduct["product_image_4"]; ?>" >
			</div>
		</div>
		<div class="image-side"> <!-- main image section -->
			<img id="main-img" src="img/magnifique-items/womens-shoes/<?php echo $getProduct["product_image_1"]; ?>" >
		</div>
		<form method="POST" action="includes/addcart.inc.php?prod_id=<?php echo $getProduct["product_id"]; ?>" class="details-side"><!-- details section -->
			...
			<input type="hidden" name="prod_img_path" value="img/magnifique-items/womens-shoes/">
			<input type="hidden" name="prod_link" value="womens-shoes-product.php">
			...
			<?php
				...
				$order_detail = array(
					...
					'qty' => '1',
					'img_path' => "img/magnifique-items/womens-shoes/". $getProduct["product_image_1"],
					'cart_id' =>  "none"
				);
			...
			<?php
				if(isset($_SESSION["customer_id"])) {
					...
					echo "<input type='hidden' name='prev_link' value='womens-shoes-product.php?product_id=".$getProduct['product_id']."'>";
			...
			<form method="POST" action="includes/review-rate.inc.php" class="review-form">
				...
				<div class="rev-form-content">
					<div class="rev-image-side">
						<img src="img/magnifique-items/womens-shoes/<?php echo $getProduct["product_image_1"]; ?>">
					</div>
