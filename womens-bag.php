...
<html lang="en">
<head>
	<title>Magnifique | Women's Bag</title>
	<meta charset="utf-8" />
		...
		<div class="categories-side">
			<div id="categoriesWrapper" >
				...
				<ul class="category-links">
					<li><a href="#wb-tote-bags">Tote Bags</a></li>
					<li><a href="#wb-wristlets">Wristlets</a></li>
					<li><a href="#wb-top-handle-bags">Top-Handle Bags</a></li>
					<li><a href="#wb-clutches">Clutches</a></li>
					<li><a href="#wb-backpacks">Backpacks</a></li>
				</ul>
			</div>	
		</div>
		<div class="items-side">
			...
			<div class="items-container">
				...
				<div class="items-group">
					<h4 id="wb-tote-bags" style="padding-top: 25px;">Tote Bags</h4>
				<?php
					$prodType = "Tote Bags";
					$getProdByType =getProductByType($conn, $prodType);

					while ($row = mysqli_fetch_assoc($getProdByType)) { ?>
					<a href="womens-bag-product.php?product_id=<?php echo $row["product_id"]; ?>">
						<div class="item">
							<img src="img/magnifique-items/womens-bag/<?php echo $row["product_image_1"]; ?>">
				...
				<div class="items-group">
					<h4 id="wb-wristlets" style="padding-top: 25px;">Wristlets</h4>
				<?php
					$prodType = "Wristlets";
					$getProdByType =getProductByType($conn, $prodType);
				...
				<div class="items-group">
					<h4 id="wb-top-handle-bags" style="padding-top: 25px;">Top-Handle Bags</h4>
				<?php
					$prodType = "Top-Handle Bags";
					$getProdByType =getProductByType($conn, $prodType);
				...
				<div class="items-group">
					<h4 id="wb-clutches" style="padding-top: 25px;">Clutches</h4>
				<?php
					$prodType = "Clutches";
					$getProdByType =getProductByType($conn, $prodType);
				...
				<div class="items-group">
					<h4 id="wb-backpacks" style="padding-top: 25px;">Backpacks</h4>
				<?php
					$prodType = "Backpacks";
					$getProdByType =getProductByType($conn, $prodType);
